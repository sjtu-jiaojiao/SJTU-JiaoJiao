...
var ActivityComponent = /** @class */ (function () {
    ...
    ActivityComponent.prototype.ngOnInit = function () {
        var _this = this;
        this.actService.getActs().subscribe(function (e) {
            _this.acts = e;
            _this.acts.forEach(function (e) { return e.validDate = new Date(e.validTime); });
            _this.acts.forEach(function (e) { return e.releaseDate = new Date(e.releaseTime); });
        });
    };
    ...
    ActivityComponent.prototype.add = function () {
        ...
        this.actService.addAct(item).subscribe(function (a) {
            return _this.actService.getActs().subscribe(function (e) {
                _this.acts = e;
                _this.acts.forEach(function (e) { return e.validDate = new Date(e.validTime); });
                _this.acts.forEach(function (e) { return e.releaseDate = new Date(e.releaseTime); });
            });
        ...
        this.bi.forEach(function (e) {
            if (e.tags && e.price)
                e.tags.forEach(function (t) {
                    _this.prcdata.push([t, e.price, e.buyInfoID]);
                });
        });
        this.goodoption = {
        ...
        if (!(this.bi.length % 100) && !dynamic)
            ...
            setTimeout(function () {
                _this.getBuyInfos(null, null, null, null, offset).subscribe(function (e) {
                    if (e && Object.keys(e).length != 0)
                        _this.bi = _this.bi.concat(e.buyInfo);
                    _this.getMoreBuy(_this.bi.length - 1, true);
                });
            }, 5000);
        }
    };
        ...
        if (!(this.si.length % 100) && !dynamic)
            ...
            setTimeout(function () {
                _this.getSellInfos(null, null, null, null, offset).subscribe(function (e) {
                    if (e && Object.keys(e).length != 0)
                        _this.si = _this.si.concat(e.sellInfo);
                    _this.getMoreSell(_this.si.length - 1, true);
                });
            }, 5000);
        }
    };

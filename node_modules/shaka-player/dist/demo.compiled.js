...
0;a<this.onSettledCallbacks_.length;++a)f.asyncExecute(this.onSettledCallbacks_[a]);this.onSettledCallbacks_=null}};var f=new b;e.prototype.settleSameAsPromise_=function(a){var b=this.createResolveAndReject_();a.callWhenSettled_(b.resolve,b.reject)};e.prototype.settleSameAsThenable_=function(a,b){var c=this.createResolveAndReject_();try{a.call(b,c.resolve,c.reject)}catch(k){c.reject(k)}};e.prototype.then=function(a,b){function c(a,b){return"function"==typeof a?function(b){try{d(a(b))}catch(r){h(r)}}:
b}var d,h,g=new e(function(a,b){d=a;h=b});this.callWhenSettled_(c(a,d),c(b,h));return g};e.prototype["catch"]=function(a){return this.then(void 0,a)};e.prototype.callWhenSettled_=function(a,b){function c(){switch(d.state_){case 1:a(d.result_);break;case 2:b(d.result_);break;default:throw Error("Unexpected state: "+d.state_);}}var d=this;null==this.onSettledCallbacks_?f.asyncExecute(c):this.onSettledCallbacks_.push(c)};e.resolve=c;e.reject=function(a){return new e(function(b,c){c(a)})};e.race=function(a){return new e(function(b,
d){for(var e=$jscomp.makeIterator(a),h=e.next();!h.done;h=e.next())c(h.value).callWhenSettled_(b,d)})};e.all=function(a){var b=$jscomp.makeIterator(a),d=b.next();return d.done?c([]):new e(function(a,e){function h(b){return function(c){f[b]=c;g--;0==g&&a(f)}}var f=[],g=0;do f.push(void 0),g++,c(d.value).callWhenSettled_(h(f.length-1),e),d=b.next();while(!d.done)})};return e},"es6","es3");
...
*/
var shakaDemo={AssetCard:function(a,b,c,d){this.card_=document.createElement("div");this.asset_=b;this.actions_=document.createElement("div");this.featureIconsContainer_=document.createElement("div");this.progressBar_=document.createElement("progress");this.remakeButtonsFn_=d;this.card_.classList.add("mdl-card-wide");this.card_.classList.add("mdl-card");this.card_.classList.add("mdl-shadow--2dp");this.card_.classList.add("asset-card");d=document.createElement("div");d.classList.add("mdl-card__title");
this.card_.appendChild(d);var e=document.createElement("h2");e.classList.add("mdl-card__title-text");e.textContent=b.shortName||b.name;d.appendChild(e);if(b.iconUri){d=document.createElement("picture");e=document.createElement("source");e.srcset=b.iconUri.replace(/.png$/,".webp");e.type="image/webp";var f=document.createElement("source");f.srcset=b.iconUri;f.type="image/png";var g=document.createElement("img");g.src=b.iconUri;g.alt="";d.appendChild(e);d.appendChild(f);d.appendChild(g);this.card_.appendChild(d)}b.description&&
c&&(c=document.createElement("div"),c.classList.add("mdl-card__supporting-text"),c.textContent=b.description,this.card_.appendChild(c));this.card_.appendChild(this.featureIconsContainer_);this.addFeatureIcons_(b);this.actions_.classList.add("mdl-card__actions");this.actions_.classList.add("mdl-card--border");this.card_.appendChild(this.actions_);c=document.createElement("div");this.progressBar_.classList.add("hidden");this.progressBar_.setAttribute("max",1);this.progressBar_.setAttribute("value",
b.storedProgress);c.appendChild(this.progressBar_);this.card_.appendChild(c);a.appendChild(this.card_);this.remakeButtons()}};shakaDemo.AssetCard.prototype.addFeatureIcon_=function(a,b){var c=document.createElement("div");c.classList.add("feature-icon");c.setAttribute("icon",a);this.featureIconsContainer_.appendChild(c);shakaDemo.Tooltips.make(c,b)};
...
this.addButton("",function(){a.makeDeleteDialog_(d)});b(d,d,"offline_pin")}else{var e=this.addButton("",function(){return $jscomp.asyncExecutePromiseGeneratorFunction(function g(){return $jscomp.generator.createGenerator(g,function(b){switch(b.nextAddress){case 1:return e.disabled=!0,b.yield(a.asset_.storeCallback(),2);case 2:a.remakeButtons(),b.jumpToEnd()}})})});b(e,e,"get_app")}};
shakaDemo.AssetCard.prototype.makeDeleteDialog_=function(a){var b=this,c=this.card_.parentElement;if(c){var d=document.createElement("dialog");d.classList.add("mdl-dialog");c.appendChild(d);d.showModal||dialogPolyfill.registerDialog(d);c=document.createElement("h2");c.classList.add("mdl-typography--title");c.textContent="Delete the offline copy?";d.appendChild(c);var e=document.createElement("div");d.appendChild(e);c=function(a,b){var c=document.createElement("button");c.textContent=a;c.classList.add("mdl-button");
c.classList.add("mdl-button--colored");c.classList.add("mdl-js-button");c.classList.add("mdl-js-ripple-effect");c.addEventListener("click",function(){b()});e.appendChild(c);c.blur()};c("Yes",function(){return $jscomp.asyncExecutePromiseGeneratorFunction(function g(){return $jscomp.generator.createGenerator(g,function(c){switch(c.nextAddress){case 1:return d.close(),a.disabled=!0,c.yield(b.asset_.unstoreCallback(),2);case 2:b.remakeButtons(),c.jumpToEnd()}})})});c("No",function(){d.close()});d.showModal()}};
shakaDemo.AssetCard.prototype.updateProgress=function(){if(1>this.asset_.storedProgress){this.progressBar_.classList.remove("hidden");for(var a=$jscomp.makeIterator(this.actions_.childNodes),b=a.next();!b.done;b=a.next())b.value.disabled=!0}else for(this.progressBar_.classList.add("hidden"),a=$jscomp.makeIterator(this.actions_.childNodes),b=a.next();!b.done;b=a.next())b.value.disabled=!1;this.progressBar_.setAttribute("value",this.asset_.storedProgress)};
shakaDemo.AssetCard.prototype.addButton=function(a,b){var c=document.createElement("button");c.classList.add("mdl-button");c.classList.add("mdl-button--colored");c.classList.add("mdl-js-button");c.classList.add("mdl-js-ripple-effect");c.textContent=a;c.addEventListener("click",function(){c.hasAttribute("disabled")||b()});this.actions_.appendChild(c);return c};shakaDemo.CloseButton=function(a,b){var c=shaka.ui.Element.call(this,a,b)||this;c.button_=document.createElement("button");c.button_.classList.add("material-icons");c.button_.classList.add("close-button");c.button_.textContent="close";c.parent.appendChild(c.button_);c.button_.addEventListener("click",function(){document.fullscreenElement&&document.exitFullscreen();document.pictureInPictureElement&&document.exitPictureInPicture();shakaDemoMain.unload()});return c};
$jscomp.inherits(shakaDemo.CloseButton,shaka.ui.Element);shakaDemo.CloseButton.prototype.destroy=function(){return Promise.resolve()};shakaDemo.CloseButton.Factory=function(){};shakaDemo.CloseButton.Factory.prototype.create=function(a,b){return new shakaDemo.CloseButton(a,b)};var ShakaDemoAssetInfo=function(a,b,c,d){this.name=a;this.shortName="";this.iconUri=b;this.manifestUri=c;this.source=d;this.disabled=this.focus=!1;this.extraText=[];this.certificateUri=null;this.description="";this.isFeatured=!1;this.drm=[shakaAssets.KeySystem.CLEAR];this.features=[];this.licenseServers=new Map;this.licenseRequestHeaders=new Map;this.drmCallback=this.responseFilter=this.requestFilter=null;this.clearKeys=new Map;this.extraConfig=null;this.storedProgress=1};
...
shakaDemo.Config.prototype.reload_=function(){shaka.ui.Utils.removeAllChildren(this.container_);this.sections_=[];this.addMetaSection_();this.addLanguageSection_();this.addAbrSection_();this.addOfflineSection_();this.addDrmSection_();this.addStreamingSection_();this.addManifestSection_();this.addRetrictionsSection_("","");this.checkSectionCompleteness_();this.checkSectionValidity_()};
shakaDemo.Config.prototype.reloadAndSaveState_=function(){var a=this.sections_.map(function(a){return a.getIsOpen()});this.reload_();for(var b=0;b<a.length;b++){var c=this.sections_[b];a[b]&&c.open()}componentHandler.upgradeDom()};
...
c,d,e);this.latestInput_.input().value=shakaDemoMain.getCurrentConfigValue(b);isNaN(Number(this.latestInput_.input().value))&&e&&(this.latestInput_.input().value="");this.addedFields_.add(b);return this};shakaDemo.Config.prototype.addDatalistInput_=function(a,b,c,d){this.createRow_(a,d);this.latestInput_=new shakaDemo.DatalistInput(this.getLatestSection_(),a,c,b);return this};
shakaDemo.Config.prototype.addSelectInput_=function(a,b,c,d){this.createRow_(a,d);this.latestInput_=new shakaDemo.SelectInput(this.getLatestSection_(),a,c,b);return this};shakaDemo.Config.prototype.createRow_=function(a,b){this.getLatestSection_().addRow(a,b||null)};
shakaDemo.Config.prototype.checkSectionCompleteness_=function(){var a=this,b=new Set(["number","string","boolean"]),c=function(d,e){for(var f in d){var g=e?e+"."+f:f,h=d[f];b.has(typeof h)?a.addedFields_.has(g)||console.warn("WARNING: Does not have config field for "+g):c(h,g)}};c(shakaDemoMain.getConfiguration(),"")};
shakaDemo.Config.prototype.checkSectionValidity_=function(){for(var a=$jscomp.makeIterator(this.addedFields_),b=a.next();!b.done;b=a.next())b=b.value,void 0==shakaDemoMain.getCurrentConfigValue(b)&&console.warn("WARNING: Invalid config field "+b)};shakaDemo.Config.prototype.getLatestSection_=function(){goog.asserts.assert(0<this.sections_.length,"Must have at least one section.");return this.sections_[this.sections_.length-1]};document.addEventListener("shaka-main-loaded",shakaDemo.Config.init);var shakaDemoCustom;
...
c.addButton("Delete",function(){return $jscomp.asyncExecutePromiseGeneratorFunction(function e(){return $jscomp.generator.createGenerator(e,function(c){switch(c.nextAddress){case 1:b.assets_["delete"](a);if(!a.unstoreCallback){c.jumpTo(2);break}return c.yield(a.unstoreCallback(),2);case 2:b.saveAssetInfos_(b.assets_),b.remakeSavedList_(),c.jumpToEnd()}})})});c.addStoreButton()})};
...
this.updateSelected_()};shakaDemo.Custom.saveId_="shakaPlayerDemoSavedAssets";document.addEventListener("shaka-main-loaded",shakaDemo.Custom.init);shakaDemo.Utils={};
...
shakaDemo.Main.prototype.readHash_=function(){var a=this,b=this.getParams_();if(this.player_){var c=this.player_.getConfiguration();shakaDemo.Utils.runThroughHashParams(function(c,d){if(c in b){var e=a.getCurrentConfigValue(d),f=b[c];"boolean"==typeof e?f="true"==f:"number"==typeof e&&(f=parseFloat(f));a.configure(d,f)}},c)}"lang"in b&&(c=b.lang,this.configure("preferredAudioLanguage",c),this.configure("preferredTextLanguage",c),this.setUILocale(c));"uilang"in b&&this.setUILocale(b.uilang);"noadaptation"in
b&&this.configure("abr.enabled",!1);"jumpLargeGaps"in b&&this.configure("streaming.jumpLargeGaps",!0);c="uncompiled";"build"in b?c=b.build:"compiled"in b&&(c="compiled");for(var d={},e=$jscomp.makeIterator(["compiled","debug_compiled","uncompiled"]),f=e.next();!f.done;d={type:d.type},f=e.next())d.type=f.value,f=document.getElementById(d.type.split("_").join("-")+"-link"),c==d.type?(f.setAttribute("disabled",""),f.removeAttribute("href"),f.title="currently selected"):(f.removeAttribute("disabled"),
f.addEventListener("click",function(b){return function(){var c=location.hash.substr(1).split(";").filter(function(a){return"compiled"!=a&&"build"!=a.split("=")[0]});c.push("build="+b.type);a.setNewHashSilent_(c.join(";"));location.reload();return!1}}(d)));this.nativeControlsEnabled_="nativecontrols"in b;shakaDemo.Utils.browserSupportsUncompiledMode()||(c=document.getElementById("uncompiled-link"),c.setAttribute("disabled",""),c.removeAttribute("href"),c.title="requires a newer browser");shaka.log&&
("vv"in b?shaka.log.setLevel(shaka.log.Level.V2):"v"in b?shaka.log.setLevel(shaka.log.Level.V1):"debug"in b?shaka.log.setLevel(shaka.log.Level.DEBUG):"info"in b&&shaka.log.setLevel(shaka.log.Level.INFO))};shakaDemo.Main.prototype.getParams_=function(){var a=location.search.substr(1);a=a?a.split(";"):[];var b=location.hash.substr(1);b=b?b.split(";"):[];a=a.concat(b);b={};for(var c=0;c<a.length;++c){var d=a[c].split("=");b[d[0]]=d.slice(1).join("=")}return b};
shakaDemo.Main.prototype.getValueFromGivenConfig_=function(a,b){for(var c=b,d=a;d;){var e=d.split(/\.(.+)/);if(3==e.length)d=e[1],c=c[e[0]];else return c[e[0]]}};shakaDemo.Main.prototype.getCurrentConfigValue=function(a){return this.getValueFromGivenConfig_(a,this.desiredConfig_)};shakaDemo.Main.prototype.resetConfiguration=function(a){this.configure(a,void 0)};
shakaDemo.Main.prototype.configure=function(a,b){2==arguments.length&&"string"==typeof a&&(a=shaka.util.ConfigUtils.convertToConfigObject(a,b));shaka.util.PlayerConfiguration.mergeConfigObjects(this.desiredConfig_,a,this.defaultConfig_);this.player_.configure(a,b)};shakaDemo.Main.prototype.getConfiguration=function(){return this.desiredConfig_};
shakaDemo.Main.prototype.requestCertificate_=function(a,b){return $jscomp.asyncExecutePromiseGeneratorFunction(function d(){var e,f,g;return $jscomp.generator.createGenerator(d,function(d){switch(d.nextAddress){case 1:return e=shaka.net.NetworkingEngine.RequestType.APP,f={uris:[a]},d.yield(b.request(e,f).promise,2);case 2:return g=d.yieldResult,d["return"](g.data)}})})};
shakaDemo.Main.prototype.unload=function(){this.selectedAsset=null;var a=document.getElementById("video-bar");this.hideNode_(a);this.video_.poster=shakaDemo.Main.mainPoster_;this.player_.unload();this.dispatchEventWithName_("shaka-main-selected-asset-changed");this.remakeHash()};
shakaDemo.Main.prototype.drmConfiguration_=function(a,b){var c=this;return $jscomp.asyncExecutePromiseGeneratorFunction(function e(){var f,g,h,l,k,n,q;return $jscomp.generator.createGenerator(e,function(e){switch(e.nextAddress){case 1:f=b?b.getNetworkingEngine():c.player_.getNetworkingEngine();goog.asserts.assert(f,"There should be a net engine.");a.applyFilters(f);g=a.getConfiguration();b?b.configure(g):(c.player_.configure(c.desiredConfig_),c.player_.configure(g));h=b?b.getConfiguration():c.player_.getConfiguration();
if(!a.certificateUri){for(var p=$jscomp.makeIterator(a.licenseServers.keys()),m=p.next();!m.done;m=p.next())l=m.value,h.drm.advanced[l]&&delete h.drm.advanced[l].serverCertificate;e.jumpTo(2);break}return e.yield(c.requestCertificate_(a.certificateUri,f),3);case 3:for(k=e.yieldResult,n=new Uint8Array(k),p=$jscomp.makeIterator(a.licenseServers.keys()),m=p.next();!m.done;m=p.next())q=m.value,h.drm.advanced[q]=h.drm.advanced[q]||{},h.drm.advanced[q].serverCertificate=n;case 2:b?b.configure(h):c.player_.configure("drm.advanced",
h.drm.advanced),c.remakeHash(),e.jumpToEnd()}})})};shakaDemo.Main.prototype.showPlayer_=function(){var a=document.getElementById("video-bar");this.showNode_(a);this.closeError_();this.video_.poster=shakaDemo.Main.mainPoster_;a.scrollIntoView({behavior:"smooth",block:"start"})};
shakaDemo.Main.prototype.loadAsset=function(a){var b=this;return $jscomp.asyncExecutePromiseGeneratorFunction(function d(){var e,f,g,h,l;return $jscomp.generator.createGenerator(d,function(d){switch(d.nextAddress){case 1:return d.setCatchFinallyBlocks(2),b.selectedAsset=a,b.showPlayer_(),b.dispatchEventWithName_("shaka-main-selected-asset-changed"),d.yield(b.drmConfiguration_(a),4);case 4:return b.controls_.getCastProxy().setAppData({asset:a}),b.nativeControlsEnabled_?(b.controls_.setEnabledShakaControls(!1),
b.controls_.setEnabledNativeControls(!0)):(b.controls_.setEnabledShakaControls(!0),b.controls_.setEnabledNativeControls(!1)),e=b,f=function(){return e.nativeControlsEnabled_?new shaka.text.SimpleTextDisplayer(e.video_):new shaka.ui.TextDisplayer(e.video_,e.container_)},b.player_.configure("textDisplayFactory",f),g=(a.storedContent?a.storedContent.offlineUri:null)||a.manifestUri,d.yield(b.player_.load(g),5);case 5:b.player_.isAudioOnly()&&(b.video_.poster=shakaDemo.Main.audioOnlyPoster_);d.leaveTryBlock(3);
break;case 2:if(l=h=d.enterCatchBlock(),l.code==shaka.util.Error.Code.LOAD_INTERRUPTED)console.debug("load() interrupted");else b.onError_(l);case 3:b.remakeHash(),d.jumpToEnd()}})})};
...
if(this.selectedAsset){c=shakaAssets.testAssets.includes(this.selectedAsset);b.push("asset="+this.selectedAsset.manifestUri);if(!c&&this.selectedAsset.licenseServers.size){var d=this.selectedAsset.licenseServers.values().next().value;b.push("license="+d);d=$jscomp.makeIterator(this.selectedAsset.licenseServers.keys());for(var e=d.next();!e.done;e=d.next())if(e=e.value,!shakaDemo.Main.commonDrmSystems.includes(e)){b.push("drmSystem="+e);break}}!c&&this.selectedAsset.certificateUri&&b.push("certificate="+
this.selectedAsset.certificateUri)}c=document.getElementById("nav-button-container");c=$jscomp.makeIterator(c.childNodes);for(d=c.next();!d.done;d=c.next())if(d=d.value,d.nodeType==Node.ELEMENT_NODE&&d.classList.contains("mdl-button--accent")){b.push("panel="+d.textContent);break}c=$jscomp.makeIterator(["compiled","debug_compiled","uncompiled"]);for(d=c.next();!d.done;d=c.next())d=d.value,document.getElementById(d.split("_").join("-")+"-link").hasAttribute("disabled")&&b.push("build="+d);this.nativeControlsEnabled_&&
b.push("nativecontrols");if(shaka.log&&shaka.log.currentLevel!=shaka.log.MAX_LOG_LEVEL)switch(shaka.log.currentLevel){case shaka.log.Level.INFO:b.push("info");break;case shaka.log.Level.DEBUG:b.push("debug");break;case shaka.log.Level.V2:b.push("vv");break;case shaka.log.Level.V1:b.push("v")}this.setNewHashSilent_(b.join(";"))}};shakaDemo.Main.prototype.setNewHashSilent_=function(a){history.replaceState(null,"",document.location.pathname+"#"+a)};shakaDemo.Main.prototype.getHamburgerMenu=function(){return document.getElementById("hamburger-menu-contents")};
shakaDemo.Main.prototype.hideNode_=function(a){a.classList.add("hidden")};shakaDemo.Main.prototype.showNode_=function(a){a.classList.remove("hidden")};
...
shakaDemo.Main.prototype.setUpVersionString_=function(){for(var a=shaka.Player.version.split("-"),b=[],c={},d=$jscomp.makeIterator(["debug","uncompiled"]),e=d.next();!e.done;c={whitelisted:c.whitelisted},e=d.next())c.whitelisted=e.value,a.includes(c.whitelisted)&&(b.push(c.whitelisted),a=a.filter(function(a){return function(b){return b!=a.whitelisted}}(c)));c=document.getElementById("version-string");c.textContent=a.join("-");0<b.length&&(c.textContent+=" ("+b.join(", ")+")")};
shakaDemo.Main.prototype.closeError_=function(){document.getElementById("error-display").classList.add("hidden");var a=document.getElementById("error-display-link");a.href="";a.textContent="";a.severity=null};shakaDemo.Main.prototype.onErrorEvent_=function(a){this.onError_(a.detail)};
...
shakaDemo.Search.prototype.makeBooleanInput_=function(a,b,c){var d=this;a.addRow(b,null,"significant-right-padding");new shakaDemo.BoolInput(a,b,function(a){a.checked?d.addDesiredTerm_(b,c,[b]):d.removeDesiredTerm_(b,c);d.remakeResultsDiv_();componentHandler.upgradeDom()})};

...
ShakaReceiver.prototype.init=function(){shaka.polyfill.installAll();var a=document.getElementById("video");goog.asserts.assert(a,"Video element should be available!");this.video_=a;a=this.video_.ui;goog.asserts.assert(a,"UI should be available!");a.configure({controlPanelElements:["play_pause","time_and_duration","spacer"]});this.player_=a.getControls().getLocalPlayer();goog.asserts.assert(this.player_,"Player should be available!");this.controlsElement_=document.querySelector(".shaka-controls-container");

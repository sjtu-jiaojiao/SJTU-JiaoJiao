...
CGO_ENABLED=0 GOOS=linux go build -a -installsuffix cgo -o ./build/api-site ./api/site/main.go
...
CGO_ENABLED=0 GOOS=linux go build -a -installsuffix cgo -o ./build/srv-site ./srv/site/main.go

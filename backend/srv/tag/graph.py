...
from text_preprocess import save_json
import numpy as np
import os
...
class Graph:
    def __init__(self, hyper_parameters):
        ...
        self.embedding_type = hyper_parameters.get('embedding_type',
                                                   'word2vec')  # 词嵌入方式，可以选择'bert'、'gpt-2'、'word2vec'或者'None'
    ...
    def create_model(self, hyper_parameters):
        ...
        if self.embedding_type == 'random':
            from embedding import RandomEmbedding as Embeddings
        elif self.embedding_type == 'char':
            from embedding import CharEmbedding3 as Embeddings
        elif self.embedding_type == 'bert':
            from embedding import BertEmbedding as Embeddings
        elif self.embedding_type == 'word2vec':
            from embedding import WordEmbedding as Embeddings
        else:
